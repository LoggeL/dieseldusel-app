...
void main() {
  ...
  group('CSV Import Parsing', () {
    test('parses semicolon-separated CSV', () {
      const line = '2026-03-08;155923;768.6;59.31;119.75;2.019;7.3;Shell KL';
      ...
      expect(double.parse(parts[6]), 7.3);
    ...
    test('handles tab-separated values', () {
      const line = '2026-03-08\t155923\t768.6\t59.31\t119.75\t2.019\t7.3\tShell';
      final parts = line.split('\t');
  ...
  group('AI Scanner Expected Values', () {
    ...
    test('dashboard expected: consumption 7.3, totalKm 155923, tripKm 768.6', () {
      ...
      expect(expectedConsumption, greaterThan(0));
  ...
  group('Full Flow Simulation', () {
    test('scan dashboard → scan receipt → create log → verify', () {
      ...
      final log = FuelLog(
        ...
        consumption: (dashboardResult['consumption'] as double),
        note: '',
      );
